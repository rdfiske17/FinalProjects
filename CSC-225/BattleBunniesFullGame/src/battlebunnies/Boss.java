...
public class Boss extends GameCharacter
{
    ...
    private String combatFeed = "";
    public String getCombatFeed()
    {
        return combatFeed;
    }
    public void setCombatFeed(String combatFeed)
    {
     ...
     */
    public void createCombatFeed(GameCharacter target)
    {
        String output = "";
        ...
        {
            output +=getName() + " used " + getActionUsed().getName() + " on " + target.getName() + " and dealt " + getDamageDealt() + " damage.";
            //System.out.println(lineBreak);
